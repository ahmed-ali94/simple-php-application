...
$fname = sanatise_input($_POST["eoi_applicant_fname"]); // sanitse the input and pass the input from the form to the variable to be used in the sql query.
$lname = sanatise_input($_POST["eoi_applicant_lname"]);

$query = "SELECT * FROM $sql_table WHERE First_Name='$fname' OR Last_Name='$lname' OR First_Name='$fname' AND Last_Name='$lname'"; // sql query
