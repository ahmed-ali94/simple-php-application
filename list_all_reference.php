...
$search = sanatise_input($_POST["eoi_reference"]); // sanitse the input and pass the input from the form to the variable to be used in the sql query.

$query = "SELECT * FROM $sql_table WHERE Position_Reference LIKE '$search%'"; // sql query
