...
$search = sanatise_input($_POST["eoi_delete"]); // sanitse the input and pass the input from the form to the variable to be used in the sql query.

$query = "DELETE FROM $sql_table WHERE Position_Reference='$search'"; // sql query
...
if (!$result) {
    ...
    echo "<p class=\"sql_msg\">Record Deleted Sucessfully</p>";
}
$query_two = "SELECT * FROM $sql_table WHERE Position_Reference='$search'";
